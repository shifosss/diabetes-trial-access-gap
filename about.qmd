...
This project ships with a conda environment specification (`jsc370.full.yml`), a `.env` template, and a reproducible Quarto pipeline. See the [README](https://github.com/shifosss/diabetes-trial-access-gap) for step-by-step reproduction instructions.
