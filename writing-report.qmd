...
Among counties with at least one trial site, endocrinologist density and trial density co-occur — both likely reflect academic medical centers and large health systems. The bivariate scatter (available on the [Visualizations page](viz.qmd)) is descriptive only; the Aim 2 models test whether these features contribute independent predictive signal.
